...
<head>
	...
	<title>Multi-Answer Multiple Choice</title>
...
<body style="background-color:#f5f5f5">
	...
	<%
		...
		ArrayList<String> choices = ((MultiAnswerMultipleChoice)thisQuestion).getChoices();
	%>
	...
	<div class="form-quiz" style="width:400px">
		...
		<%
			for (int i = 0; i < choices.size(); i++){
				out.println("<input type=\"checkbox\" name=\"answer\" value=\"" + choices.get(i) + "\"/> " + choices.get(i) + "<br>");
			}
		%>
		</form>
		...
		<h5>Correct Answer: 
		<% 
			ArrayList<String> actualAnswers = thisQuestion.getAnswer();
			String quizOutput = "";
			for(int j =0; j < actualAnswers.size(); j++)//adds up actual answers for question
			{
