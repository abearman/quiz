...
/**
 * Servlet implementation class ClearHistoryForQuizServlet
 */
@WebServlet("/ClearHistoryForQuizServlet")
public class ClearHistoryForQuizServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ClearHistoryForQuizServlet() {
        super();
